...
const ProjectDetail = (props) => {
  ...
  return (
    <Layouts>
      <PageBanner pageTitle={"Projektinformation"} pageDesc={""} />
        ...
        <div className="container">
          <ul className="next-prev-projects">
            {prev_id != 0 && prev_id != undefined && (
              <li className="prev">
                <Link href={`/de/projects2/${prev_id}`}>
            ...
            {next_id != 0 && next_id != undefined && (
              <li className="next">
                <Link href={`/de/projects2/${next_id}`}>
                    ...
                    {postData.details.items.map((item, key) => (
                      ...
                      >
                        <div className="project-d-detail">
                          ...
                          <div className="d-flex-all icon"></div>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <>
          ...
          <div className="gap no-top project-detail-slider">
            <div className="container-fluid g-0">
              <Swiper {...sliderProps.projDetailsSlider} className="p-d-slider">
...
export async function getStaticProps({ params }) {
  ...
  const relatedPosts = await getRelatedProjects(params.id, false);
