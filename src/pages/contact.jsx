        ...
        <section className="gap contact-form-2">
            ...
            <div className="row">
                ...
                <div className="bio">
                    <div className="data">
                        <figure>
                            <img className="author" src="/img/pic1.jpg" alt="Bio Image" />
                        </figure>
                        <h3>Eng. Mostafa Shouman</h3>
                    </div>
                </div>
                <div className="info">
                    <ul className="contact">
                        <li>
                            ...
                            <div>
                                <h3>Address:</h3>
                                <p>1. 45964 Gladbeck Mittelstraße 32 Deutschland</p>
                                <p>2. Lebanon - Beirut</p>
                            </div>
                        </li>
                        <li>
     ...
     <div className="row">
       ...
       {/* Lebanon Map */}
        <div className="contact-map col-lg-6">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24264.99954376945!2d35.505103106575514!3d33.88764809943049!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151f8d5d9e5d4ef5%3A0x2821c6a7d14f5a6d!2sBeirut%2C%20Lebanon!5e0!3m2!1sen!2s" width="600" height="400" style={{border: 0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>

        {/* Germany Map */}
        <div className="contact-map col-lg-6">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2479.5828944834166!2d6.986737076624188!3d51.57587957182901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b8eedc097d8bf1%3A0x424004a030edde37!2sMittelstra%C3%9Fe%2032%2C%2045964%20Gladbeck%2C%20Germany!5e0!3m2!1sen!2slb!4v1702306800131!5m2!1sen!2slb" width="600" height="400" style={{border: 0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
    </Layouts>
  );
