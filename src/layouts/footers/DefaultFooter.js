    ...
    <footer className="footer-style-one">
          ...
          <div className="row">
            ...
            {/* <div className="col-lg-4 col-md-6 col-sm-12">
              <div className="footer-col">
                ...
                <form
                  action={data.settings.mailchimp.url}
                  method="post"
                  target="_blank"
                >
                  <input
                    ...
                    required
                  />
                  <input type="hidden" name={data.settings.mailchimp.key} />
                  <button type="submit">
      ...
      <div className="footer-p-3 rights">
        <div className="container">
          <div className="row">
            <div className="footer-col">
              <p dangerouslySetInnerHTML={{ __html: data.footer.copy }} />
