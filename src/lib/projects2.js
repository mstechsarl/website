...
const projectsDirectory = path.join(process.cwd(), "src/data/projects2");
const projectsDirectoryDe = path.join(process.cwd(), "src/data/projectsDe2");

export function getSortedProjectsData(en) {
